  ...
  return (
    <section className="box skills">
      ...
      <div className="stack gap-2 lg:gap-4">
        ...
        <p>
          I was a president for 5 years, leading projects and growing the organization. As a football coach for 2 years, I improved my
      ...
      <div className="stack gap-2 lg:gap-4">
        ...
        <p>
          I always want to get better and learn about new technology in the market. I look for chances to grow my skills and use new ideas
          in my work.
        </p>
      </div>
    </section>
